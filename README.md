...
### GitHub Download
**Go to the [Releases page](https://github.com/538Michael/UIInfoSuite2/releases) on the side, where you can always find the latest release. Download the UIInfoSuite2.zip file and copy it's content to the mod folder.**
...
**This is a fork of [Annosz's UIInfoSuite2](https://github.com/Annosz/UIInfoSuite2).**
...
<tr>
    <td align="center">
        <a href="https://github.com/538Michael">
            <img src="https://avatars.githubusercontent.com/u/4532464?v=4" width="100;" alt="538Michael"/>
        </a>
        <br />
        <sub><b>Michael</b></sub>
        <br />
        <a href="https://github.com/538Michael/UIInfoSuite2/commits?author=538Michael" title="Code">💻</a></td>
    </td></tr>
</table>

## All contributors

<a href="https://github.com/538Michael/UIInfoSuite2/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=538Michael/UIInfoSuite2" />
</a>
